...
| C4 | round-trip Node-Node: `Decrypt(Encrypt(text)) === text` para `text in ["", "a", "ASCII text", "açúcar", "{\"idUser\":1,\"loginUser\":\"processa\\\\guga\",\"passwordUser\":\"x\",\"validarGrupo\":\"\",\"validarLDAP\":false}"]` | identidade preservada | `assert.strictEqual` em cada caso | `Cryptography.cs:36-73` |
