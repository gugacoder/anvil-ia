...
| F011 | components | Renderer DFtipo=grid (DataGrid2) | `react-tools/components/DataGrid2/` + `react-tools/components/GenericPage/GenericGridPage.js` + `react-tools/hooks/useDataGrid.js` | [[model-valor-datagrid]] | P0 | ready-for-test | — | — |
