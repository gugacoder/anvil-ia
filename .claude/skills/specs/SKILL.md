---
name: specs
description: Gerar documentos de especificacao (requirements, user stories, ER, design, UI guide, feature spec) seguindo os padroes do projeto.
user_invocable: true
---

# Spec Patterns — Como Escrever specs/

Guia de escrita para os documentos de especificacao em `specs/`. Siga estas convencoes ao gerar qualquer spec.
...
Quando o usuario invocar esta skill:

1. Pergunte qual tipo de spec (requirements, user stories, ER, design, UI guide, feature spec) se nao foi especificado
2. Pergunte o nome do projeto e topico se nao fornecidos
3. Gere a spec seguindo estritamente o formato do tipo escolhido
4. Valide contra o checklist de qualidade antes de entregar
5. Salve o arquivo em `specs/` com o nome `{projeto}-{topico}.md`
