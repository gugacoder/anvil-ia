---
name: prp
description: Gerar um PRP (Product Requirements Prompt) — contrato operacional entre humano e IA com decisoes explicitas, limites rigidos e execution mode definido.
user_invocable: true
---
...
Ao gerar um PRP, use esta estrutura:
...
1. Pergunte qual e o objetivo/feature se nao foi fornecido
2. Gere o PRP completo seguindo a estrutura acima
3. Valide contra o checklist antes de entregar
4. Apresente o PRP em um code block markdown para facil copia
