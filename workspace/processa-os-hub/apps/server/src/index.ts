// =============================================================================
// Processa OS hub — backend Hono. NIC-style: shell e apps externos cada um
// em sua porta, hub server expoe APIs comuns + registry de apps.
// =============================================================================
...
serve({ fetch: app.fetch, port: PORT }, (info) => {
  ...
  console.log(`[hub-server] http://localhost:${info.port}${PUBLIC_PATH}/ · apps=${REGISTRY.length}`);
  setTimeout(() => {
    bus.emit({
      kind: "system",
      title: "Processa OS Hub",
