...
export function HomeAppIcon({ app, size = "lg", onClick, onDoubleClick }: Props) {
  const Icon = app.Icon;
  ...
  return (
    ...
    >
      <span
        className={`grid ${tile} place-items-center rounded-2xl bg-foreground/12 ring-1 ring-foreground/15 shadow-md backdrop-blur-md`}
      >
