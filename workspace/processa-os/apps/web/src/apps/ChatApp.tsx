// =============================================================================
// Anvil Chat — usa @codrstudio/openclaude-chat (vendored em src/components/).
// pt-BR fixo, model select e language select desligados.
// =============================================================================
...
export function ChatApp() {
  ...
  const [sessionId, setSessionId] = useState<string | null>(() =>
    localStorage.getItem("os.chat.session"),
  );

  useEffect(() => {
    if (sessionId) {
      localStorage.setItem("os.chat.session", sessionId);
    } else {
      localStorage.removeItem("os.chat.session");
    }
  }, [sessionId]);
