...
Repositórios clonados do GitLab interno da Processa (`gitlab.processa.info`), usados como material de estudo.

Convenção de nomes: o caminho do projeto no GitLab é achatado em um único nome de pasta substituindo `/` por `--`.

Para reconstruir esta pasta do zero:
